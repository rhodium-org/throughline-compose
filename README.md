...
grounded IDD spine of <!-- tl:count.inline type == 'user_requirement' -->7<!-- tl:end --> user requirements and <!-- tl:count.inline type == 'system_requirement' -->23<!-- tl:end --> system requirements 
